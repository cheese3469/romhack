...
#define OW_CHOOSE_FROM_PC_AND_PARTY     FALSE       // If enabled, NPCs like move tutors or trainers asking for trade will let you pick a Pokémon from your PC or party instead of just your party
