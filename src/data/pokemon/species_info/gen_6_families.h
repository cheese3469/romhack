...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_GALE_WINGS, ABILITY_NONE, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TALONFLAME] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_NONE, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_RED,
...
#define SPEWPA_SPECIES_INFO(evolution)                                          \
    {                                                                           \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_VIVILLON_##evolution}), \
    }
