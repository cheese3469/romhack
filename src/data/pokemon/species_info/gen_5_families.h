...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_PATRAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANALYTIC, ABILITY_CHEEK_POUCH, ABILITY_KEEN_EYE },
    ...
    [SPECIES_PIDOVE] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_OBLIVIOUS, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TYMPOLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_PALPITOAD}),
    },
    ...
    [SPECIES_VENIPEDE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SWARM, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TRUBBISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STENCH, ABILITY_DRY_SKIN, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MINCCINO] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_TECHNICIAN, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FOONGUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MYCELIUM_MIGHT, ABILITY_NONE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_WHITE,
