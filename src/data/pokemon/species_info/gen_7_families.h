...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BATTERY, ABILITY_MINUS, ABILITY_SWARM },
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_MINUS, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 27, SPECIES_LYCANROC_MIDNIGHT, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_NO_GUARD, ABILITY_INTIMIDATE, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
