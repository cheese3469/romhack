...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_NONE, ABILITY_ADAPTABILITY },
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_PLUS, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_TRANSISTOR, ABILITY_PLUS, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_INFILTRATOR, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_JUMPLUFF}),
    },
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .abilities = { ABILITY_UNAWARE, ABILITY_WATER_ABSORB, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_SHELL_ARMOR, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_ARMOR_TAIL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
