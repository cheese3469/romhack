...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] = { _("{PKMN} TRAINER"), 10 },
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("{PKMN} TRAINER"), 10 },
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 10, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 10 },
    [TRAINER_CLASS_COLLECTOR] = { _("COLLECTOR"), 10, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("SWIMMER♂"), 10, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA"), 10 },
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 10, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("HEX MANIAC"), 10 },
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 10 },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 10 },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 10 },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 10 },
    [TRAINER_CLASS_LADY] = { _("LADY"), 10 },
    [TRAINER_CLASS_BEAUTY] = { _("BEAUTY"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("RICH BOY"), 10 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 10 },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 10 },
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 10 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 10 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 10 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 10 },
    [TRAINER_CLASS_PSYCHIC] = { _("PSYCHIC"), 10 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 10, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 100, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("LEADER"), 50, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID"), 10 },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. AND JR."), 10 },
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 10 },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 10 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 200, BALL_MASTER },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 10 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 10 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 10 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 10, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 10 },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 10 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 10, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 20 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 10 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 10 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 10 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 10 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 10 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("SALON MAIDEN"), 10, BALL_ULTRA },
